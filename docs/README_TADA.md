> Upstream README from the TADA code release (luk-st/steer-audio @ `75ff8b9`),
> preserved here because it documents this tree's layout and the inherited
> patching / CAA / SAE commands. Upstream has since restructured.
> The current project README is at the repository root.
